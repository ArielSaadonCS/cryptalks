"""The only module that calls external APIs: CoinGecko (prices + price
history), CryptoPanic (news), and OpenRouter (AI insight). Each follows
the same live -> cache -> static fallback chain, plus the static meme
catalog.
"""
